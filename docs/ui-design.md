...
_None open right now._ Earlier entries were either promoted to [GitHub issues](https://github.com/andybywire/sanity-plugin-mermaid-content-model/issues) or dropped — both recoverable from this file's git history. Add postponed UI choices here as they surface under real use.
